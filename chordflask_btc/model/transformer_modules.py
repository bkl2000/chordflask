"""BTC-ISMIR19 transformer building blocks (adapted from the MIT-licensed BTC code).

Kept verbatim from the original project so the published checkpoint state dict
loads unchanged. The module/attribute names below define the exact state-dict
keys, so they must not be renamed.
"""
