...
# Pure chord-label logic moved to the neutral base layer; re-export it so
# existing ``chordutils.<name>`` call sites keep working unchanged.
from chordflask_base.chordlabel import (  # noqa: E402,F401
    expand_chord_labels,
    respell_chord_label,
    respell_pitch,
    rle_chord_labels,
